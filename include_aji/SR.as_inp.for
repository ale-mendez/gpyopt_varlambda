...
!      do i=1,nc
!         print1000,i,t(i),sc(i),pc(i),lc(i),cfc(i),gic(i),ec(i)
!      enddo
!1000  format(7(i4),f12.6)
!      do i=1,ntranc
!         print1001,i,lwpc(i),lwsc(i),lwlc(i),lwcfc(i),
!     |               uppc(i),upsc(i),uplc(i),upcfc(i),akic(i)
!      enddo
!1001  format(i3,1x,"lw=",4(i4),1x,"up=",4(i4),1x,1p,e12.5)

!      do i=1,nlevels
!      print1000,lv(i),is(i),il(i),igi(i),ip(i),icf(i),dek(i)
!      enddo
!1000  format(6(i4),f12.6)
!      do i=1,ntranc
!         print1001,i,lwpc(i),lwsc(i),lwlc(i),lwgic(i),lwcfc(i),
!     |               uppc(i),upsc(i),uplc(i),upgic(i),upcfc(i),akic(i)
!      enddo
!1001  format(i3,1x,"lw=",5(i4),1x,"up=",5(i4),1x,1p,e12.5)
