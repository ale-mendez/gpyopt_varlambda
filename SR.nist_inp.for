...
!         print*,aji,acc,ei,dum,ek,lcf,lt,lj,ucf,ut,uj
         itr=itr+1
         akie(itr)=aji
         lwgie(itr)=2*lj+1
         upgie(itr)=2*uj+1
...
210      continue
!         write(*,*) itr,akie(itr),fvalue
!     |             lwcfe(itr),lwse(itr),lwle(itr),lwpe(itr),lwgie(itr),
!     |             upcfe(itr),upse(itr),uple(itr),uppe(itr),upgie(itr)
200   continue
201   ntrane=itr
!      print*,"read ",ntrane," transitions from NIST"
