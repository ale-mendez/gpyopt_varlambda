...
def load_Jmindata(folder):
    ...
    filename="Be"+str(ncfgs)+"CFGSTO_"+str(initer)+"GP"+str(maxevals)
...
def load_erpdata(folder):
    global filename,ntran
    nskip=list(range(1,11))
...
def plot_akierp(erp):
    ...
    ax1=plt.subplot(121)
    tran1,=plt.plot(erp[0]['er%'],erp[0].index,c=colors[0],marker=symbs[0],linestyle='None',markersize=12,label=r"$2s\,^1S_0\rightarrow 2p\,^1P_1$")
    tran2,=plt.plot(erp[1]['er%'],erp[1].index,c=colors[1],marker=symbs[1],linestyle='None',markersize=12,label=r"$2s\,^1S_0\rightarrow 3p\,^1P_1$")
    tran3,=plt.plot(erp[2]['er%'],erp[2].index,c=colors[2],marker=symbs[2],linestyle='None',markersize=12,label=r"$2s\,^1S_0\rightarrow 2p\,^3P_2$")
    plt.ylabel("N",fontsize=35,labelpad=ypad)
    plt.xlabel(r"Error relativo \%",fontsize=35,labelpad=xpad,position=(1,0))
#    plt.xlim(akierp_min1,akierp_max1)
    ax2=plt.subplot(122)
    tran4,=plt.plot(erp[3]['er%'],erp[3].index,c=colors[3],marker=symbs[3],linestyle='None',markersize=12,label=r"$2s\,^1S_0\rightarrow 3p\,^3P_1$")
    tran5,=plt.plot(erp[4]['er%'],erp[4].index,c=colors[4],marker=symbs[4],linestyle='None',markersize=12,label=r"$2s\,^1S_0\rightarrow 4p\,^1P_1$")
