...
!      integer invi,invf
      ...
      common/lamidxbck/idxlam(NMX),inmx
...
!***********************************************************************
      ...
      character fsalgebfin*32,fsalgeb*163
...
!... write namelist SALGEB
      ...
      fsalgebfin="'KUTSO=0 NMETAJ=1 NMETA=1 &END')"
      fsalgeb=fhead//fsalgebini//fmxvorb//fmxconf//fsalgebfin
!      arad="'NO'"
      if(RAD.eq."NO") arad="'NO'"
      if(RAD.eq."E1") arad="'E1'"
      if(RAD.eq."E2") arad="'E2'"
      if(RAD.eq."E3") arad="'E3'"
      if(RAD.eq."ALL") arad="'ALL'"
      if(CUP.eq."CA") acup="'CA'"
      if(CUP.eq."LS") acup="'LS'"
      if(CUP.eq."LSM") acup="'LSM'"
      if(CUP.eq."IC") acup="'IC'"
      if(CUP.eq."ICR") acup="'ICR'"
      if(CUP.eq."ICM") acup="'ICM'"
