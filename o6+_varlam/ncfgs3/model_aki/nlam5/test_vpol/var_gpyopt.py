...
global ii, npolvar, initmap, cost, chatom
...
def def_filename():
    global ncfg, filename,initer,chatom
...
#    rho_min=[0.200,0.200,0.200]
    alpha_max=[0.,0.2,0.000]
    alpha_min=[0.,0.01,0.000]
    rho_max=[1.0,1.00,1.000]
    rho_min=[1.0,0.20,1.000]
    npolvar=3
